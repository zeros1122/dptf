...
\t\t\t\t<spread_percentage>2.00</spread_percentage>\n\
\t\t\t</pixel_clock_capabilities>\n\
\t\t\t<pixel_clock_data_set>\n\
\t\t\t\t<pixel_clock>\n\
\t\t\t\t\t<pixel_clock_number>0</pixel_clock_number>\n\
\t\t\t\t\t<pixel_clock_data>\n\
...
\t\t\t<candidate_sets>\n\
\t\t\t\t<candidate_set>\n\
\t\t\t\t\t<name>SSC Disabled Candidate Set</name>\n\
\t\t\t\t\t<pixel_clock_frequency_table>\n\
\t\t\t\t\t\t<spread_type>Center</spread_type>\n\
\t\t\t\t\t\t<spread_percentage>0.50</spread_percentage>\n\
\t\t\t\t\t\t<pixel_clock_frequencies>\n\
\t\t\t\t\t\t\t<pixel_clock>\n\
\t\t\t\t\t\t\t\t<pixel_clock_number>0</pixel_clock_number>\n\
\t\t\t\t\t\t\t\t<frequency>138780000</frequency>\n\
\t\t\t\t\t\t\t\t<frequency>139380000</frequency>\n\
\t\t\t\t\t\t\t\t<frequency>138180000</frequency>\n\
\t\t\t\t\t\t\t\t<frequency>139980000</frequency>\n\
\t\t\t\t\t\t\t\t<frequency>137580000</frequency>\n\
\t\t\t\t\t\t\t\t<frequency>140580000</frequency>\n\
\t\t\t\t\t\t\t\t<frequency>136980000</frequency>\n\
\t\t\t\t\t\t\t\t<frequency>141180000</frequency>\n\
\t\t\t\t\t\t\t\t<frequency>136380000</frequency>\n\
\t\t\t\t\t\t\t\t<frequency>141780000</frequency>\n\
\t\t\t\t\t\t\t\t<frequency>135780000</frequency>\n\
\t\t\t\t\t\t\t</pixel_clock>\n\
\t\t\t\t\t\t</pixel_clock_frequencies>\n\
\t\t\t\t\t</pixel_clock_frequency_table>\n\
\t\t\t\t</candidate_set>\n\
\t\t\t\t<candidate_set>\n\
\t\t\t\t\t<name>SSC Enabled Candidate Set</name>\n\
\t\t\t\t\t<pixel_clock_frequency_table>\n\
\t\t\t\t\t\t<spread_type>Up</spread_type>\n\
\t\t\t\t\t\t<spread_percentage>1.00</spread_percentage>\n\
\t\t\t\t\t\t<pixel_clock_frequencies>\n\
\t\t\t\t\t\t\t<pixel_clock>\n\
\t\t\t\t\t\t\t\t<pixel_clock_number>0</pixel_clock_number>\n\
\t\t\t\t\t\t\t\t<frequency>138780000</frequency>\n\
...
static const char* ExpectedStatusPixelClocksGpsFiltered = "\
<!-- format_id=49-18-CE-C4-3A-24-F3-49-B8-D5-F9-70-02-F3-8E-6A -->\n\
<act_policy_status>\n\
\t<fivr_device_list/>\n\
\t<radio_device_list>\n\
...
\t\t\t<candidate_sets>\n\
\t\t\t\t<candidate_set>\n\
\t\t\t\t\t<name>SSC Disabled Candidate Set (GPS Filtered)</name>\n\
\t\t\t\t\t<pixel_clock_frequency_table>\n\
\t\t\t\t\t\t<spread_type>Center</spread_type>\n\
\t\t\t\t\t\t<spread_percentage>0.50</spread_percentage>\n\
\t\t\t\t\t\t<pixel_clock_frequencies>\n\
...
\t\t\t\t</candidate_set>\n\
\t\t\t\t<candidate_set>\n\
\t\t\t\t\t<name>SSC Enabled Candidate Set (GPS Filtered)</name>\n\
\t\t\t\t\t<pixel_clock_frequency_table>\n\
\t\t\t\t\t\t<spread_type>Up</spread_type>\n\
\t\t\t\t\t\t<spread_percentage>1.00</spread_percentage>\n\
\t\t\t\t\t\t<pixel_clock_frequencies>\n\
...
\n";
TEST_F(ActPolicyWithPixelParticipants, ShowsExpectedStatusWithGpsFiltering)
{
    EXPECT_CALL(platformConfiguration, readConfigurationUInt32("FilterForGps"))
        .WillOnce(Return(1));
    policy->create(true, policyServices, 0);
    ...
    std::string status = policy->getStatusAsXml();
    ASSERT_STREQ(status.c_str(), ExpectedStatusPixelClocksGpsFiltered);
}