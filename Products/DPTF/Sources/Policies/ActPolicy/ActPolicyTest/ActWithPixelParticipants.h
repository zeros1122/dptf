...
class ActPolicyWithPixelParticipants : public ActPolicyWithNoParticipants
{
...
public:
    ...
    MockDomainPixelClockStatusInterface pixelClockStatus;
    MockDomainPixelClockControlInterface pixelClockControl;

    ActPolicyWithPixelParticipants::ActPolicyWithPixelParticipants(void)
    ...
    virtual void SetUp() override {
        ...
        policyServices.domainPixelClockControl = &pixelClockControl;
        policyServices.domainPixelClockStatus = &pixelClockStatus;
    }
